				...
				'margins'       => array(
					...
					'fields'        => array(
						'margin_top' => array(
							...
							'responsive'  => array(
								'placeholder' => array(
									'default'    => ( isset( $global_settings->column_margins ) ) ? $global_settings->column_margins : '0',
									'medium'     => ( isset( $global_settings->column_margins_medium ) ) ? $global_settings->column_margins_medium : '',
									'responsive' => ( isset( $global_settings->column_margins_responsive ) ) ? $global_settings->column_margins_responsive : '',
								)
							)
						),
						'margin_bottom' => array(
				...
				'padding'       => array(
					...
					'fields'        => array(
						'padding_top' => array(
							...
							'responsive'  => array(
								'placeholder' => array(
									'default'    => ( isset( $global_settings->column_padding ) ) ? $global_settings->column_padding : '0',
									'medium'     => ( isset( $global_settings->column_padding_medium ) ) ? $global_settings->column_padding_medium : '',
									'responsive' => ( isset( $global_settings->column_padding_responsive ) ) ? $global_settings->column_padding_responsive : '',
								)
							)
						),
