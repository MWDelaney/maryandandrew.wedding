				...
				'margins'       => array(
					...
					'fields'        => array(
						'margin_top' => array(
							...
							'responsive'  => array(
								'placeholder' => array(
									'default'    => ( isset( $global_settings->row_margins ) ) ? $global_settings->row_margins : '',
									'medium'     => ( isset( $global_settings->row_margins_medium ) ) ? $global_settings->row_margins_medium : '',
									'responsive' => ( isset( $global_settings->row_margins_responsive ) ) ? $global_settings->row_margins_responsive : '',
								)
							)
						),
						'margin_bottom' => array(
				...
				'padding'       => array(
					...
					'fields'        => array(
						'padding_top' => array(
							...
							'responsive'  => array(
								'placeholder' => array(
									'default'    => ( isset( $global_settings->row_padding ) ) ? $global_settings->row_padding : '',
									'medium'     => ( isset( $global_settings->row_padding_medium ) ) ? $global_settings->row_padding_medium : '',
									'responsive' => ( isset( $global_settings->row_padding_responsive ) ) ? $global_settings->row_padding_responsive : '',
								)
							)
						),
